		...
		Fidoo.loadSignatureData = function () {
			...
			if(Fidoo.runningNodeJS) {
				try { // TODO more catching
					Fidoo.pronomSignatures = require(Fidoo.nodeJSONUri + Fidoo.pronomSignaturesJSON);
					Fidoo.extensionPuidMap = require(Fidoo.nodeJSONUri + Fidoo.extensionPuidMapJSON);
					Fidoo.mimePuidMap = require(Fidoo.nodeJSONUri + Fidoo.mimePuidMapJSON);
					}
				catch(error) {
