		...
		Fidoo.loadSignatureData = function (which) {
			...
			if(which == "nodeJS") {
				try { // TODO more catching
					Fidoo.registerJSON(require(Fidoo.nodeJSON + Fidoo.pronomSignaturesJSON), "pronomSignatures");
					Fidoo.registerJSON(require(Fidoo.nodeJSON + Fidoo.extensionPuidMapJSON), "extensionPuidMap");
					Fidoo.registerJSON(require(Fidoo.nodeJSON + Fidoo.mimePuidMapJSON), "mimePuidMap");
					}
				catch(error) {
			...
			if(which == "browser") {
				try { // TODO more catching
					Fidoo.loadJSON(Fidoo.browserJSON + Fidoo.pronomSignaturesJSON, "pronomSignatures");
					Fidoo.loadJSON(Fidoo.browserJSON + Fidoo.extensionPuidMapJSON, "extensionPuidMap");
					Fidoo.loadJSON(Fidoo.browserJSON + Fidoo.mimePuidMapJSON, "mimePuidMap");
					}
				catch(error) {
					Fidoo.logHandler("fatal error: ", error);
					}				
